...
#define _suNf_multiply(r,u,s) \
      _complex_mulr((r).c[0],(u).c[0],(s).c[0]);\
      _complex_mulr_assign((r).c[0],(u).c[1],(s).c[1]); \
      _complex_mulr_assign((r).c[0],(u).c[2],(s).c[2]); \
      _complex_mulr((r).c[1],(u).c[3],(s).c[0]);\
      _complex_mulr_assign((r).c[1],(u).c[4],(s).c[1]); \
      _complex_mulr_assign((r).c[1],(u).c[5],(s).c[2]); \
      _complex_mulr((r).c[2],(u).c[6],(s).c[0]);\
      _complex_mulr_assign((r).c[2],(u).c[7],(s).c[1]); \
      _complex_mulr_assign((r).c[2],(u).c[8],(s).c[2])

/* SU(N) matrix u^dagger times SU(N) vector s */
/* r=(u^dagger)*s */
#define _suNf_inverse_multiply(r,u,s) \
      _complex_mulr((r).c[0],(u).c[0],(s).c[0]);\
      _complex_mulr_assign((r).c[0],(u).c[3],(s).c[1]); \
      _complex_mulr_assign((r).c[0],(u).c[6],(s).c[2]); \
      _complex_mulr((r).c[1],(u).c[1],(s).c[0]);\
      _complex_mulr_assign((r).c[1],(u).c[4],(s).c[1]); \
      _complex_mulr_assign((r).c[1],(u).c[7],(s).c[2]); \
      _complex_mulr((r).c[2],(u).c[2],(s).c[0]);\
      _complex_mulr_assign((r).c[2],(u).c[5],(s).c[1]); \
      _complex_mulr_assign((r).c[2],(u).c[8],(s).c[2])
...
#define _suNf_FMAT(u,s) \
   _complex_mul_star_assign_re((u).c[0],(s).c[0].c[0],(s).c[2].c[0]); \
   _complex_mul_star_assign_re((u).c[0],(s).c[1].c[0],(s).c[3].c[0]);\
   _complex_mul_star_assign_re((u).c[1],(s).c[0].c[0],(s).c[2].c[1]); \
   _complex_mul_star_assign_re((u).c[1],(s).c[1].c[0],(s).c[3].c[1]);\
   _complex_mul_star_assign_re((u).c[2],(s).c[0].c[0],(s).c[2].c[2]); \
   _complex_mul_star_assign_re((u).c[2],(s).c[1].c[0],(s).c[3].c[2]);\
   _complex_mul_star_assign_re((u).c[3],(s).c[0].c[1],(s).c[2].c[0]); \
   _complex_mul_star_assign_re((u).c[3],(s).c[1].c[1],(s).c[3].c[0]);\
   _complex_mul_star_assign_re((u).c[4],(s).c[0].c[1],(s).c[2].c[1]); \
   _complex_mul_star_assign_re((u).c[4],(s).c[1].c[1],(s).c[3].c[1]);\
   _complex_mul_star_assign_re((u).c[5],(s).c[0].c[1],(s).c[2].c[2]); \
   _complex_mul_star_assign_re((u).c[5],(s).c[1].c[1],(s).c[3].c[2]);\
   _complex_mul_star_assign_re((u).c[6],(s).c[0].c[2],(s).c[2].c[0]); \
   _complex_mul_star_assign_re((u).c[6],(s).c[1].c[2],(s).c[3].c[0]);\
   _complex_mul_star_assign_re((u).c[7],(s).c[0].c[2],(s).c[2].c[1]); \
   _complex_mul_star_assign_re((u).c[7],(s).c[1].c[2],(s).c[3].c[1]);\
   _complex_mul_star_assign_re((u).c[8],(s).c[0].c[2],(s).c[2].c[2]); \
   _complex_mul_star_assign_re((u).c[8],(s).c[1].c[2],(s).c[3].c[2])
